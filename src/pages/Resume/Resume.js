    ...
    return (
        <section id="resume" className="resume text-start mt-5 pt-md-5">
            <div className="container">
                ...
                <p className=""><button className="btn text-primary fs-6 underline ps-0 pe-1"><a href="https://drive.google.com/uc?export=download&id=1aXzudIyYfWNo1oMf4FolQ8UGp5Pt0rsD">Download</a></button>| <button className="btn text-primary fs-6 underline ps-0"><a target="_blank" href="https://drive.google.com/file/d/1aXzudIyYfWNo1oMf4FolQ8UGp5Pt0rsD/view?usp=sharing" >View</a></button></p>
